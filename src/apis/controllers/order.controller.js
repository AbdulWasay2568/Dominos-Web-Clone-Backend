...
exports.getOrderByUserIdController = exports.removeOrderController = exports.updateOrderController = exports.getOrderByIdController = exports.getAllOrderController = exports.createOrderController = void 0;
...
const getAllOrderController = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const removeOrderController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield orderService.deleteOrder(Number(req.params.id));
        res.status(204).send();
    }
    catch (error) {
...
const getOrderByUserIdController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const orders = yield orderService.getOrdersByUserId(Number(req.params.id));
        res.json(orders);
    }
    catch (error) {
        res.status(500).json({ error: 'Failed to fetch orders' });
...
exports.getOrderByUserIdController = getOrderByUserIdController;
