...
exports.updateUserImage = exports.deleteUser = exports.updateUser = exports.getAllUsers = exports.getUserById = exports.createUser = void 0;
...
const updateUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const userId = Number(req.params.id);
    const user = yield usersService.updateUser(userId, req.body);
    res.json({ user });
});
exports.updateUser = updateUser;
const deleteUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield usersService.deleteUser(Number(req.params.id));
    res.status(204).send();
});
...
const updateUserImage = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updatedUser = yield usersService.updateUserImageService(userId, req.file);
