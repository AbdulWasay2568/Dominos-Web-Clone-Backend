...
const addonOptionsController = __importStar(require("../controllers/addonOptions.controller"));
const addonOptionsRouter = (0, express_1.Router)();
...
exports.default = addonOptionsRouter;
