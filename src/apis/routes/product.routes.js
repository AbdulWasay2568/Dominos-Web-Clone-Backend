...
productRouter.patch('/:id/image', upload_middleware_1.uploadProductImage.single('image'), productController.updateProductImage);
productRouter.post('/addons/', upload_middleware_1.uploadProductImage.single('image'), productController.createProductWithAddonsController);
