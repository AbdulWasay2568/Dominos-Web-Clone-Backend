...
const shippingInfoController = __importStar(require("../controllers/shippingInfo.controller"));
const shippingInfoRouter = (0, express_1.Router)();
...
exports.default = shippingInfoRouter;
